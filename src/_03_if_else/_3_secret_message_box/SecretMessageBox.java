...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		String password = "5897";
		// 2. Using a pop-up, ask the first person for a secret message and store it in
		// a variable
		String Answer = JOptionPane.showInputDialog("Type a secret message");
		// 3. Now use a pop-up to tell the NEXT user that they can only see the secret
		// message
		// if they can guess the passcode
		String Guess = JOptionPane.showInputDialog("You may only view the secret message if you guess correctly");
		;
